...
namespace Ex03.GarageLogic
{
    public class FuelTank : Energy
    {
        ...
        // default is fuel tank to be full capacity
        ...
        {
            string DetailsOfFuel = string.Format("Energy Type: FuelTank{0}" + "Fuel type: {1}{0}", Environment.NewLine, m_FuelType);

            return base.ToString() + DetailsOfFuel;
        }
